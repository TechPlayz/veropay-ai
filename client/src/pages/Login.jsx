...
function Login() {
  ...
  const handleSubmit = (event) => {
    ...
    // }
    //
    // Your backend teammate can replace this
    // with the actual API request.
        ...
        <div className="relative z-10 flex flex-col justify-between p-14 w-full">
          ...
          <div className="max-w-lg">
            ...
            <p className="text-gray-400 text-lg leading-8 mt-6">
              Track your earnings, identify potential underpayments
              and make smarter decisions about your gig work.
            </p>

          </div>

          <p className="text-gray-600 text-xs">
            VeroPay uses AI-assisted estimates to identify potential
        ...
        <div className="w-full max-w-md">
          ...
          <div className="mb-9">
            ...
            <p className="text-gray-400 mt-3">
              Sign in to access your VeroPay dashboard.
            </p>
