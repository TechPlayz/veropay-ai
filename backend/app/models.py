...
class User(Base):
    """Minimal worker model. Authentication can be connected later."""
...
class Vehicle(Base):
    """Reference values used to pre-fill a rider's operating costs."""
...
class Ride(Base):
    """A submitted ride and its deterministic fair-fare analysis."""
